...
describe('actions', () => {
  ...
  describe('using createImage', () => {
    it('should create an action with request payload', () => {
      const { createImage } = actions;
      const { CREATE_IMAGE } = types;
      const id = 1;
      ...
      expect(createImage({ id, data })).toEqual(expectedValue);
      ...
      expect(createImage({ id, data, options })).toEqual(expectedValue);
    ...
    it('should create an action for cancelled create main image request', () => {
      const { createImageCancel } = actions;
      const { CREATE_IMAGE_CANCEL } = types;
      const expectedValue = {
        type: CREATE_IMAGE_CANCEL,
      };

      expect(createImageCancel()).toEqual(expectedValue);
    });

    it('should create an action for failed request', () => {
      const { createImageFailure } = actions;
      const { CREATE_IMAGE_FAILURE } = types;
      const expectedValue = {
        type: CREATE_IMAGE_FAILURE,
        error: {},
      };

      expect(createImageFailure()).toEqual(expectedValue);

      expectedValue.error = axiosResponseError;

      expect(createImageFailure(axiosResponseError)).toEqual(expectedValue);
    });

    it('should create an action for successful request', () => {
      const { createImageSuccess } = actions;
      const { CREATE_IMAGE_SUCCESS } = types;
      const expectedValue = {
        type: CREATE_IMAGE_SUCCESS,
      };

      expect(createImageSuccess()).toEqual(expectedValue);
    });
  });
  ...
  describe('using deleteImage', () => {
    it('should create an action with request payload', () => {
      const { deleteImage } = actions;
      const { DELETE_IMAGE } = types;
      const id = 1;
      const itemId = 1;
      const options = {
        a: 1,
      ...
      expect(deleteImage({ id, itemId })).toEqual(expectedValue);
      ...
      expect(deleteImage({ id, itemId, options })).toEqual(expectedValue);
    ...
    it('should create an action for failed request', () => {
      const { deleteImageFailure } = actions;
      const { DELETE_IMAGE_FAILURE } = types;
      const expectedValue = {
        type: DELETE_IMAGE_FAILURE,
        error: {},
      };

      expect(deleteImageFailure()).toEqual(expectedValue);

      expectedValue.error = axiosResponseError;

      expect(deleteImageFailure(axiosResponseError)).toEqual(expectedValue);
    });

    it('should create an action for successful request', () => {
      const { deleteImageSuccess } = actions;
      const { DELETE_IMAGE_SUCCESS } = types;
      const expectedValue = {
        type: DELETE_IMAGE_SUCCESS,
      };

      expect(deleteImageSuccess()).toEqual(expectedValue);
    });
  });
...
describe('reducer', () => {
  ...
  it('should handle CREATE_IMAGE_FAILURE', () => {
    let action = actions.createImageFailure();
    const expectedValue = {
      ...defaultInitialState,
      error: {},
    };
    ...
    action = actions.createImageFailure(axiosResponseError);
    expectedValue.error = axiosResponseError;
  ...
  it('should handle DELETE_IMAGE_FAILURE', () => {
    let action = actions.deleteImageFailure();
    const expectedValue = {
      ...defaultInitialState,
      error: {},
    };
    ...
    action = actions.deleteImageFailure(axiosResponseError);
    expectedValue.error = axiosResponseError;
  ...
  it('should handle DELETE_IMAGE_SUCCESS', () => {
    const action = actions.deleteImageSuccess();
    const expectedValue = {
      ...defaultInitialState,
    };
  ...
  it('should handle CREATE_IMAGE_SUCCESS', () => {
    const data = { id: 1 };
    const action = actions.createImageSuccess(data);
    const expectedValue = {
      ...defaultInitialState,
    };
